/**
 * new Env("阅看点极速版")
 * cron 11 9,18 * * *  yuekandian.js
 * Show: 每天1
 * 变量名:yuekandian
 * 变量值:https://ykd.yichengwangluo.net/api headers中Authorization的值（去掉Bearer）&device的值&&User-Agent中（）里面的值 例如(Linux; U; Android 11; XIAOMI 8 MIUI/V11.0.1.0.QXXXXXM)
...
const $ = new Env("阅看点极速版");
const ckName = "yuekandian";
...
class UserInfo {
    ...
    async cash_info() {
        try {
            let options = {
                url: `https://ykd.yichengwangluo.net/api/v2/cash/exchange`,
    ...
    async barrierGet() {//闯关
        try {
            try {
                let options = {
                    url: `https://ykd.yichengwangluo.net/api/v2/reward/barrier/index`,
                    headers: this.getHeaders,
                },
                    result = await httpRequest(options);
                //console.log(options);
    ...
    async task_list(type) {
        try {
            //只有0-5可以做
            let options = {
                url: `https://ykd.yichengwangluo.net/api/v2/zhuan/index`,
                headers: this.postHeaders,
                body: " "
            },
                result = await httpRequest(options);
    ...
    async signIn() {
        try {
            let options = {
                url: `https://ykd.yichengwangluo.net/api/v2/reward/sign`,
                headers: this.postHeaders,
                body: ` `
            },
                result = await httpRequest(options);
    ...
    async task_done(id) {
        try {
            let options = {
                url: `https://ykd.yichengwangluo.net/api/v2/zhuan/done`,
                headers: this.postHeaders,
                body: `id=${id}`
            },
                result = await httpRequest(options);
    ...
    async news_cost() {
        try {
            let options = {
                url: `https://ykd.yichengwangluo.net/api/v2/news/cost`,
                headers: this.getHeaders,
            },
                result = await httpRequest(options);
            //console.log(options);
    ...
    async news_coin_start() {
        try {
            let options = {
                url: `https://ykd.yichengwangluo.net/api/v2/news/coin`,
                headers: this.getHeaders,
            },
                result = await httpRequest(options);
            //console.log(options);
    ...
    async news_coin_do(ticket) {
        try {
            let options = {
                url: `https://ykd.yichengwangluo.net/api/v2/news/coin?ticket=${ticket}`,
                headers: this.getHeaders,
            },
                result = await httpRequest(options);
            //console.log(options);
    ...
    async news_coin_end() {
        try {
            let options = {
                url: `https://ykd.yichengwangluo.net/api/v2/news/cost?end=1`,
                headers: this.getHeaders,
            },
                result = await httpRequest(options);
            //console.log(options);
    ...
    async kan_click(id) {
        try {
            let options = {
                url: `https://ykd.yichengwangluo.net/api/v2/kan/click?id=${id}`,
                headers: this.getHeaders,
            },
                result = await httpRequest(options);
            //console.log(options);
    ...
    async kan_index(ticket, id) {
        try {
            let options = {
                url: `https://ykd.yichengwangluo.net/api/v2/kan/index`,
                headers: this.postHeaders,
    ...
    async zhuan_count1() {
        try {
            let options = {
                url: `https://ykd.yichengwangluo.net/api/v2/news/sdk/zhuan/count?isfirstopen=1`,
                headers: this.getHeaders,
            },
                result = await httpRequest(options);
            //console.log(options);
    ...
    async zhuan_count0() {
        try {
            let options = {
                url: `https://ykd.yichengwangluo.net/api/v2/news/sdk/zhuan/count?isfirstopen=0`,
                headers: this.getHeaders,
            },
                result = await httpRequest(options);
            //console.log(options);
    ...
    async video_cost() {
        try {
            let options = {
                url: `https://ykd.yichengwangluo.net/api/v2/video/cost?type=short`,
                headers: this.getHeaders,
            },
                result = await httpRequest(options);
            //console.log(options);
    ...
    async video_coin_start() {
        try {
            let options = {
                url: `https://ykd.yichengwangluo.net/api/v2/video/coin`,
                headers: this.getHeaders,
            },
                result = await httpRequest(options);
            //console.log(options);
    ...
    async video_coin_do(ticket) {
        try {
            let options = {
                url: `https://ykd.yichengwangluo.net/api/v2/video/coin?ticket=${ticket}`,
                headers: this.getHeaders,
            },
                result = await httpRequest(options);
            //console.log(options);
    ...
    async video_coin_end() {
        try {
            let options = {
                url: `https://ykd.yichengwangluo.net/api/v2/video/cost?type=short&end=1`,
                headers: this.getHeaders,
            },
                result = await httpRequest(options);
            //console.log(options);
    ...
    async action_init() {
        try {
            let options = {
                url: `https://ykd.yichengwangluo.net/api/v2/ads/action/init`,
                headers: this.getHeaders,
            },
                result = await httpRequest(options);
            //console.log(options);
    ...
    async action_video() {
        try {
            let options = {
                url: `https://ykd.yichengwangluo.net/api/v2/zhuan/video`,
                headers: this.postHeaders,
                body: "type=1"
            },
                result = await httpRequest(options);
    ...
    async action_load(type) {
        try {
            let options = {
                url: `https://ykd.yichengwangluo.net/api/v2/ads/action/load?class=10000&&channel=2&type=${type}`,
                headers: this.getHeaders,
            },
                result = await httpRequest(options);
            //console.log(options);
    ...
    async action_showd(tid, type) {
        try {
            let options = {
                url: `https://ykd.yichengwangluo.net/api/v2/ads/action/showed?class=10000&channel=2&type=${type}&ecpm=${this.ecpm}&tid=${tid}&platformname=6`,
                headers: this.getHeaders,
            },
                result = await httpRequest(options);
            //console.log(options);
    ...
    async action_completed(ticket, tid, type) {
        try {
            let options = {
                url: `https://ykd.yichengwangluo.net/api/v2/ads/action/completed?class=10000&type=${type}&ticket=${ticket}&ecpm=${this.ecpm}&tid=${tid}&platformname=6`,
                headers: this.getHeaders,
            },
                result = await httpRequest(options);
            //console.log(options);
